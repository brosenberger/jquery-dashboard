(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("jqueryui", [], factory);
	else if(typeof exports === 'object')
		exports["jqueryui"] = factory();
	else
		root["Dashboard"] = root["Dashboard"] || {}, root["Dashboard"]["jqueryui"] = factory();
})(this, function() {
...
module.exports = (Handlebars['default'] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<form class=\"form-horizontal\">\r\n    "
    + ((stack1 = (helpers.block || (depth0 && depth0.block) || helpers.helperMissing).call(depth0 != null ? depth0 : {},"settings",{"name":"block","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "\r\n</form>";
},"useData":true});
...
module.exports = (Handlebars['default'] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"widget-"
    ...
    + "        </div>\r\n        <div class=\"panel-additional panel-loading\" style=\"display:none;\"><i class=\"fa fa-spinner fa-pulse fa-3x fa-fw\"></i></div>\r\n        <div class=\"panel-additional panel-notconfigured\" style=\"display:none;\"><i class=\"fa fa-cog fa-pulse fa-3x fa-fw\"></i>Bitte konfigurieren</div>\r\n        <div class=\"panel-body\">\r\n            "
...
exports.LocalStorageDataService = undefined;
...
var LocalStorageDataService = exports.LocalStorageDataService = function (_DataService) {
    _inherits(LocalStorageDataService, _DataService);

    function LocalStorageDataService(storageLocation) {
        _classCallCheck(this, LocalStorageDataService);

        var _this = _possibleConstructorReturn(this, (LocalStorageDataService.__proto__ || Object.getPrototypeOf(LocalStorageDataService)).call(this));

        _this.storageLocation = storageLocation;
        return _this;
    }
    ...
    _createClass(LocalStorageDataService, [{
        ...
        value: function createWidgetConfiguration(widgetType) {
            ...
            return new Promise(function (resolve, reject) {
                var widgetData = that._generateRandomWidgetData(widgetType);
        ...
        key: 'removeWidgetConfiguration',
        value: function removeWidgetConfiguration(widgetId) {
            var widgetList = this._findStoredWidgets();
        ...
        value: function _saveStoredWidgets(widgets) {
            localStorage.setItem(this.storageLocation, JSON.stringify(widgets));
        }
    }, {
        key: '_generateRandomWidgetData',
        value: function _generateRandomWidgetData(widgetType) {
            return {
...
var Service = exports.Service = function () {
    ...
    _createClass(Service, [{
        ...
        value: function removeWidgetData(widgetId) {
            this.dataService.removeWidgetConfiguration(widgetId);
        }
    }, {
        key: 'createWidgetData',
        value: function createWidgetData(widgetType) {
        ...
        value: function _checkWidgetType(widgetType) {
...
(function ($) {
    $.widget('brocode.dashboardWidgetDialog', {
        options: {
            ...
            modalTemplate: __webpack_require__(38),
            listItemTemplate: __webpack_require__(39)
        },
                    ...
                    buttons: {
                        save: {
                            ...
                            callback: function callback(event) {
                                return that.options.dashboardService.saveConfiguration(widgetData.id, widgetData.configurationValues(dialog)).then(function (result) {
...
//# sourceMappingURL=jquery.dashboard.jqueryui.js.map